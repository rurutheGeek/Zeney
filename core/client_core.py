...
class ClientCore:
    ...
    def __init__(self, my_port=50082, core_host=None, core_port=None, callback=None):
        ...
        print('ClientCoreを初期化中...')
        self.my_ip = self.__get_myip()
        print('サーバーのIPアドレス ... ', self.my_ip)
    ...
    def send_req_full_chain_to_my_core_node(self):
        print('send_req_full_chain_to_my_core_node が呼び出されました')
    ...
    def __handle_message(self, msg):
        if msg[2] == RSP_FULL_CHAIN:
            ...
            # P2P Network を単なるトランスポートして使っているアプリケーションが独自拡張したメッセージはここで処理
